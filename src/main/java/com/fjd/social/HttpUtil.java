...
CmtClient cfg = CmtClient.getInstance();
...
//    }
    ...
    private String getTextResponse(HttpRequestBase httpRequest) {
    ...
    private HttpEntity getResponseEntity(CloseableHttpResponse response) {
        ...
        if (!status.startsWith("2")) {
            ...
            try {
                ...
                throw new ServerException(status, description);
            } catch (ParseException e) {
...
//    }
    ...
    private HttpRequestBase getHttpRequest(String url, String method, Map<String, String> header,
        ...
        try {
            ...
            throw new BusinessException("SocialCommonErrorCode.INVALID_URL"+url);
        }
        if (httpRequest == null) {
            LOGGER.error("getHttpRequest httpRequest is null, method:{}, url:{}"+ method+ url);
            throw new BusinessException("SocialCommonErrorCode.INVALID_METHOD"+ method);
        }
        if (header != null) {
    ...
    static HttpEntity setUpEntity(Map<String, Object> parameterMp, String parameterType) {
        ...
        } else if (PARAMETER_TYPE_JSON.equals(parameterType)) {
